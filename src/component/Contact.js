...
const Contact =()=>{
 ...
 <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
  <div className=" pt-8">
   <p className="text-4xl font-bold inline border-b-4 border-gray-500 pt-8">Contact</p>
   <p className="py-6">Submit the from below to get touch with me</p>
  </div>
  <div className="flex justify-center items-center pb-12">
   <form action="https://getform.io/f/67220b73-d502-4040-b3ba-a071f5c6dacb" method="post" className="flex flex-col w-full md:w1/2">
    ...
    <textarea required placeholder="Enter Your message" name="message" rows="10" className="p-2 bg-transparent border-2 rounded-md text-white focus:outline-none"></textarea>
